...
public class SourceDocumentInformation extends Annotation {
  ...
  //*--------------*
  //* Feature: isLastDocument

  /** getter for isLastDocument - gets To be set by the collection reader and used to print out statistics for the annotation of the collection.
   * @generated
   * @return value of the feature 
   */
  public boolean getIsLastDocument() {
    if (SourceDocumentInformation_Type.featOkTst && ((SourceDocumentInformation_Type)jcasType).casFeat_isLastDocument == null)
      jcasType.jcas.throwFeatMissing("isLastDocument", "org.apache.uima.examples.SourceDocumentInformation");
    return jcasType.ll_cas.ll_getBooleanValue(addr, ((SourceDocumentInformation_Type)jcasType).casFeatCode_isLastDocument);}
    
  /** setter for isLastDocument - sets To be set by the collection reader and used to print out statistics for the annotation of the collection. 
   * @generated
   * @param v value to set into the feature 
   */
  public void setIsLastDocument(boolean v) {
    if (SourceDocumentInformation_Type.featOkTst && ((SourceDocumentInformation_Type)jcasType).casFeat_isLastDocument == null)
      jcasType.jcas.throwFeatMissing("isLastDocument", "org.apache.uima.examples.SourceDocumentInformation");
    jcasType.ll_cas.ll_setBooleanValue(addr, ((SourceDocumentInformation_Type)jcasType).casFeatCode_isLastDocument, v);}    
  }
