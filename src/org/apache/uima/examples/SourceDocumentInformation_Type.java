...
public class SourceDocumentInformation_Type extends Annotation_Type {
  ...
  /** @generated */
  final Feature casFeat_isLastDocument;
  /** @generated */
  final int     casFeatCode_isLastDocument;
  /** @generated
   * @param addr low level Feature Structure reference
   * @return the feature value 
   */ 
  public boolean getIsLastDocument(int addr) {
        if (featOkTst && casFeat_isLastDocument == null)
      jcas.throwFeatMissing("isLastDocument", "org.apache.uima.examples.SourceDocumentInformation");
    return ll_cas.ll_getBooleanValue(addr, casFeatCode_isLastDocument);
  }
  /** @generated
   * @param addr low level Feature Structure reference
   * @param v value to set 
   */    
  public void setIsLastDocument(int addr, boolean v) {
        if (featOkTst && casFeat_isLastDocument == null)
      jcas.throwFeatMissing("isLastDocument", "org.apache.uima.examples.SourceDocumentInformation");
    ll_cas.ll_setBooleanValue(addr, casFeatCode_isLastDocument, v);}
  ...
  public SourceDocumentInformation_Type(JCas jcas, Type casType) {
    ...
    casFeat_isLastDocument = jcas.getRequiredFeatureDE(casType, "isLastDocument", "uima.cas.Boolean", featOkTst);
    casFeatCode_isLastDocument  = (null == casFeat_isLastDocument) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_isLastDocument).getCode();
