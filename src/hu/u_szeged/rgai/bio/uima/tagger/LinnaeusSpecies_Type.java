...
public class LinnaeusSpecies_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("hu.u_szeged.rgai.bio.uima.tagger.LinnaeusSpecies");
  ...
  public String getMostProbableSpeciesId(int addr) {
      ...
      jcas.throwFeatMissing("mostProbableSpeciesId", "hu.u_szeged.rgai.bio.uima.tagger.LinnaeusSpecies");
  ...
  public String getAllIdsString(int addr) {
      ...
      jcas.throwFeatMissing("allIdsString", "hu.u_szeged.rgai.bio.uima.tagger.LinnaeusSpecies");
  ...
  public boolean getAmbigous(int addr) {
      ...
      jcas.throwFeatMissing("ambigous", "hu.u_szeged.rgai.bio.uima.tagger.LinnaeusSpecies");
